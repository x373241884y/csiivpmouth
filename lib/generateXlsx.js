	...
	function createXlsx() {
		return new Promise(function (resolve, reject) {
			...
			for (var k = 0; k < 12; k++) {
				...
				sheet1.getCell('B1').value =  _day.format('YYYYMMDD');
				...
				sheet1.getCell('A1').fill=titleStyle1;
				sheet1.getCell('B1').fill=titleStyle1;
				sheet1.getCell('C1').fill=titleStyle1;
				sheet1.getCell('D1').fill=titleStyle1;
				sheet1.getCell('E1').fill=titleStyle1;
				sheet1.getCell('F1').fill=titleStyle1;
				...
				for (var i = 1; i <= days; i++) {
					...
					if (weekday === 1) {
						...
						sheet1.getCell('A' + index).fill = titleStyle3;
						sheet1.getCell('B' + index).fill = titleStyle3;
						sheet1.getCell('C' + index).fill = titleStyle3;
						sheet1.getCell('D' + index).fill = titleStyle3;
						sheet1.getCell('E' + index).fill = titleStyle3;
						sheet1.getCell('F' + index).fill = titleStyle3;
						// sheet1.addRow(index).commit();
						index += 1;
					}
